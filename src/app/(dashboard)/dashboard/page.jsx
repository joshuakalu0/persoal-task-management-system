          ...
          <div className="min-h-screen w-full bg-background p-6">
            <div className="max-w-7xl mx-auto space-y-8">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-2xl border border-border/50">
                <div>
                  <h1 className="text-3xl font-bold text-foreground bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-400">
                ...
                <div className="flex gap-3">
                  ...
                  <Link
                    href="/tasks/new"
                    className="btn-secondary text-white px-6 py-2.5 rounded-xl hover:bg-secondary/90 transition-all duration-300 shadow-lg hover:shadow-secondary/20 hover:-translate-y-0.5"
                  >
                    New Task
                  </Link>
                </div>
                        ...
                        <div className="mt-6 flex justify-between items-end">
                          <div className="flex -space-x-2">
                            {project.members?.slice(0, 3).map((member) => (
                              <div
                                key={member.user.id}
                                className="w-8 h-8 rounded-full bg-primary/10 border-2 border-background flex items-center justify-center text-sm font-medium text-primary"
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <Link
                          key={task.id}
                          href={`/tasks/${task.id}`}
                          className="block p-4 rounded-lg bg-background hover:bg-secondary/5 transition-all duration-300"
                        >
